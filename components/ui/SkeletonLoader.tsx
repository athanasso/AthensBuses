...
export function LineSkeleton({ colorScheme = 'dark' }: LineSkeletonProps) {
  ...
  return (
    <View style={[styles.lineItem, { backgroundColor: colors.card, borderColor: colors.border }]}>
      <SkeletonLoader width={50} height={32} radius={16} colorScheme={colorScheme} />
...
export function ArrivalSkeleton({ colorScheme = 'dark' }: LineSkeletonProps) {
  ...
  return (
    <View style={[styles.arrivalItem, { borderColor: colors.border }]}>
      <SkeletonLoader width={48} height={24} radius={12} colorScheme={colorScheme} />
      <View style={styles.arrivalTextContainer}>
        <SkeletonLoader width={160} height={14} colorScheme={colorScheme} />
      </View>
      <SkeletonLoader width={60} height={20} radius={4} colorScheme={colorScheme} />
    </View>
  );
}
